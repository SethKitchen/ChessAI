...
namespace SethRocks
{
    internal static class Utils
    {
        ...
        /// This will be either "SethRocks YYMMDD" (where YYMMDD is the date when
        /// the program was compiled) or "SethRocks <version number>", depending
        ...
        internal static string engine_info(bool to_uci)
        {
            ...
            sb.Append("SethRocks ").Append(versionInfo).Append(cpu64);
            sb.Append(to_uci ? "\nid author " : " by ").Append("Seth Kitchen for MegaMiner AI Chess Spring 2017");
            return sb.ToString();
        }
